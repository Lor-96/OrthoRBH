...
def argparserextra1():
    ...
    parser.add_argument('-lvl',type=str , required=False ,default = None ,metavar='--level', help='LEVEL OF ANALYSIS BETWEEN THE 2 SPECIES PRECEDED BY "at" I.E. DROSOPHILIDAE = at7214' )
    ...
    parser.add_argument('-lv2sp', type=str, required = True, metavar='--level2species', help='PATH TO THE LEVEL2SPECIES.TAB FILE' )
