def extra_n7_pipeline(oneiso1,oneiso2,gtf1,gtf2,genome1,genome2,logical):
    ...
    if logical == True:
        ...
        lista_sp1=cds_utr.readoneisoID(oneiso1,table_protein_transcript_sp1)
        ...
        lista_sp2=cds_utr.readoneisoID(oneiso2,table_protein_transcript_sp2)
